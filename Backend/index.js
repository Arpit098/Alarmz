...
// Function to send equivalent tokens on BSC
// async function sendTokensBSC(amount) {
//     const gasPriceBsc = ((await providerBSC.getFeeData()).gasPrice);

//     const tx = {
//         to: targetAddress,
//         value: ethers.parseEther(amount.toString()), // Use the received amount
//         gasLimit: 21000,
//         gasPrice: gasPriceBsc,
//     };

//     try {
//         const txResponse = await walletBSC.sendTransaction(tx);
//         console.log(`Transaction sent on BSC with hash: ${txResponse.hash}`);
//         await txResponse.wait(); // Wait for transaction to be mined
//         console.log('Transaction on BSC mined');
//     } catch (error) {
//         console.error('Error sending tokens on BSC:', error);
//     }
// }

// Function to send equivalent tokens on Polygon
